    ...
    const dashBoardOptions = <>

        {
            isAdmin ? <>
                ...
                <NavLink to="/contract"><li className="flex gap-2 items-center"><IoMdMail /> Contact</li></NavLink>
            </> :
                <>
                    ...
                    <NavLink to="/dashboard/mycart"><li className="flex gap-2 items-center"><FaCartPlus /> My Cart</li></NavLink>
        ...
        <div className="flex flex-col lg:flex-row min-h-screen bg-gray-100">
            ...
            <div className="lg:hidden p-4 bg-yellow-800 text-white flex justify-between items-center">
                ...
                <details className="relative">
                    ...
                    <ul className="absolute right-0 mt-2 w-56 bg-yellow-800 text-white p-4 rounded-lg shadow-lg space-y-3 z-10">
                        {dashBoardOptions}
                    </ul>
                </details>
            </div>
